<?php
    ...
    $sql="select DATE_SUB(DATE_SUB(now(),INTERVAL 0 HOUR),INTERVAL -1 MINUTE) as fechaactual,CONCAT(f_start_date,' ',horafin) as fechaevento from t_events where f_start_date >= DATE_FORMAT(NOW(), '%Y-%m-%d') order by f_start_date asc";
