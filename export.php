...
if(!empty($_GET['ex'])){
        ...
        if($_GET['ex']=='1'){
            ...
            $_GET['tbl_name'] ="Bids";
            $_GET['sql_fields'] = "
            select h.f_history_id as History_id, h.f_lot_id as Id,l.f_number as Lote, h.f_user_id as UserId, h.f_username as Username, h.f_date as Date_Bid, h.f_amount as Amount from t_lots_history h inner join t_lots l on h.f_lot_id = l.f_lots_id";
            include("export-process.php");
             exit;
