...
class rcube_directadmin_password
{
	...
	$Socket->set_ssl_setting_message("DirectAdmin appears to be using SSL. Change your /var/www/html/roundcube/plugins/password/config.inc.php and set \$config['password_directadmin_host'] = 'ssl://localhost';");
        $Socket->query('/CMD_API_CHANGE_EMAIL_PASSWORD',
            array(
                'email'         => $da_user,
