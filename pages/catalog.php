...
<div id="Finaliza" class="text-center"><span>Finaliza en:  <strong><span style="font-size:20px;" id="countdown">  </span></strong></span></div>
...
<div id="Finaliza" class="text-center"><span>Inicia en:  <strong><span style="font-size:20px;" id="countdown"> </span></strong></span></div>
  ...
  margin-bottom: 20px;
    ...
    max-height: 240px;text-align: center;vertical-align: middle">          			    
								...
								<?php } ?>
                                 ...
                                 <!-- <img src="<?php echo HOME_URL ?>rimage/products/<?php echo $imagecat.'.e.jpg';?>" class="same-size" alt="" style="width: 275px;height: 151px;text-align: center;vertical-align: middle">-->
                                 <?php 
    ...
    text-overflow: ellipsis;" id="<?php echo $value['f_lots_id']?>" 
                                  ...
                                  <?php if(isset($_GET['status'])): ?>
									...
									if($value['f_selected']==1){ ?>
										 <p style="font-size:12px;" class=" blink_me  btn btn-success btn-xs btn-block btn-script-<?php echo (isset($_SESSION['auction_brodcaster'])) ? 'bid':'login' ?>" data-data='<?php echo json_encode($value, JSON_NUMERIC_CHECK ) ?>'><i class="fas fa-gavel fa-pulse"></i> Ofertar</p>
									...
									if($value['f_start_date']!=$datenow){
									 ...
									 <p class="btn btn-primary btn-xs btn-block btn-script-<?php echo (isset($_SESSION['auction_brodcaster'])) ? 'bid':'login' ?>" data-data='<?php echo json_encode($value, JSON_NUMERIC_CHECK ) ?>'><i class="fas fa-gavel"></i> Ofertar</p>
                                    ...
                                    if($value['f_status'] == '1'){ 
                                        ...
                                        <p style="margin-top:5px;text-align: center;width: 100%;font-size: 14px !important;}" class="btn btn-primary btn-xs btn-script-<?php echo $goto_bid ?>" data-data='<?php echo json_encode($value, JSON_NUMERIC_CHECK ) ?>'><i class="fas fa-gavel"></i> Ofertar</p>
