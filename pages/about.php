  ...
  <main id="main" style="margin-top:20px !important;">
    ...
    color: #666;" data-aos="fade-up"><?php echo $title  ?></h1>
         ...
         <div style="margin-bottom: 20px;overflow: hidden;border-radius: 5px;background: #fff;box-shadow: 0px 1px 6px rgb(230 231 231);">
    ...
    text-align: center;
    font-weight: 300;
    color: #666;" data-aos="fade-up">Instituciones de apoyo</h1>
        </div>
          </div>
