          ...
          <div class="sidebar-sticky">
            ...
            <?php endif ?>
              ...
              <li class="nav-item has-treeview">
                ...
                <li class="nav-item">
                    <a href="deleteoferts.php" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview d-none pl-3">
                  ...
                  <?php if($_SESSION['auctiobroad']['user_id']== '1') :?>
                  <li class="nav-item">
                    <a href="ClientesLotes.php" class="nav-link">
                      <i class="nav-icon fas fa-users"></i>
                      Lotes por Cliente
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="ofertassinadjudicar.php" class="nav-link">
                      <i class="nav-icon fas fa-users"></i>
                      Lotes de interes
                    </a>
                  </li>
                  <!-- <li class="nav-item">
                    <a href="Comprasporcliente.php" class="nav-link">
                      <i class="nav-icon fas fa-users"></i>
                      Compras por cliente
                    </a>
                  </li> -->
                  <li class="nav-item">
                    <a href="Ofertasactuales.php" class="nav-link">
                      <i class="nav-icon fas fa-users"></i>
                      Ofertas actuales por evento
                    </a>
                  </li>
                  <?php endif ?>
                </ul>
