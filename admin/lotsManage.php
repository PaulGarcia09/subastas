                  ...
                  <table class="dataTables table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php foreach ($result as $key => $value): 
                        $value['f_title']=utf8_encode($value['f_title']);
                        $value['f_description']=utf8_encode($value['f_description']);
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td><img src="<?php echo HOME_URL ?>rimage/products/<?php echo $imagecat.'.a.jpg';?>" width="150" class="img-thumbnail" alt=""></td>
                          <td>
