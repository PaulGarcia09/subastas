  ...
  overflow: hidden;">
          ...
          <div class="col-lg-4" style="
            ...
            overflow: hidden;">
                <div style="padding: 5px; display: flex; flex-wrap: nowrap;width: 100%">
                  ...
                  <div style="width: 50%; font-weight: 600; text-align:left;font-size: x-large;">Presencial/Línea</div>
                  <div style="width: 50%; font-weight: 600; text-align:right;font-size: x-large;">Oferta</div>      
                 </div>     
  
                <div class="card card-light" style="height:200px;font-size: 25px;">
                    <div class="history"></div>
                </div>
               <!--<h1 class="animado" style="font-size:2.5rem !important;font-weight:bold !important;" id="ofertaalta"></h1>!-->
   ...
   <!-- <div  style="background-color:white;padding: 5px; display: flex; flex-wrap: nowrap;width: 100%;box-shadow: 0 1px 1px rgba(0,0,0,0.15);border-radius: 2px;">
              <div style="width: 50%; font-weight: 600; text-align:left;font-size: x-large;">7213</div>
                ...
                <img src="paleta.png" style="width:320px;cursor: pointer" alt="Snow">
	...
	left: 50%;
	transform: translate(-50%, -50%);">
  <!--<a style="font-size:68px;cursor: pointer; color:white;" id="palet"></a>!-->
  <a style="font-size: 70px;cursor: pointer;color:white;" id="palet"></a><br>
    <a style="font-size: 40px;cursor: pointer;color:white;" id="ofertaalta"></a></div>

  <h1 class="animado" style="font-weight:bold !important;">Siguiente: 
  <h1 class="animado" style="font-weight:bold !important;font-size:4.2rem !important" id="ofertasiguiente"></h1></h1>
  
<hr>  

<div class="alert alert-info alert-dismissible fade show" style="font-size: 14px;height: 100px; padding:0px;
    ...
    height: 40px;
    margin-top: 25px;"/> 
             <p id="msgbid" style="line-height:normal;margin-top:15px;margin-left:10px;font-weight: bolder;font-size: 35px;color:#030D84 !important"> <?php echo $result['f_message'];?></p>
            </div>
...
$("#msgbid").fadeIn(200).fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200);
       ...
       success: function(result) {					
         try { 
           ...
           if(responson.result=='ok'){
            ...
            if(ofertamasalta !== 0){
                if(ofertamasalta !== responson.currentbid && parseFloat(responson.paleta) > 100 ){
                  entro =1;
                  $( ".flash" ).removeClass( "animate--drop-in-fade-out" );
                    $(".button").click();
                    $(".reproduce").click();
            ...
            $('#ofertasiguiente').html("$ "+responson.button1);
